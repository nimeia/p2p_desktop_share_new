...
int main() {
  {
    ...
    assert(controller.BuildDashboardUrl() == "https://10.0.0.12:9443/host?room=roomA&token=tokA");
    assert(controller.BuildViewerUrl() == "https://10.0.0.12:9443/view?room=roomA&token=tokA");
